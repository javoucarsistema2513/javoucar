    ...
    <div className="flex flex-col h-full bg-gray-50 relative auth-form-container">
      ...
      <div className="w-full relative auth-header">
        ...
        <div className="absolute bottom-6 left-4 z-10">
            <h2 className="text-2xl font-bold text-white mb-1">Cadastrar Veículo</h2>
                ...
                <div className="w-full mb-2">
                    ...
                    <div className="relative">
                        ...
                        <select
                            ...
                            onChange={handleChange}
                            className="w-full rounded-xl border-2 bg-white py-3 pl-10 pr-8 text-gray-900 focus:border-brand-yellow focus:ring-brand-yellow focus:outline-none appearance-none border-gray-200 text-sm"
                        >
